...
To ensure maximum reliability and truthfulness, the system features an automated **LLM-as-a-Judge** evaluation framework (`src/evaluation/metrics_runner.py`). A **50-sample Golden Test Suite** based on college policy documents is run through the pipeline and evaluated using `llama-3.3-70b-versatile` as the judge, producing the following benchmark scores:

### 🏆 Core Performance Scores

| Evaluation Metric | Mathematical Logic Layer | Engine Score | Acceptability Baseline | Production Safeguard |
| :--- | :---: | :---: | :---: | :--- |
